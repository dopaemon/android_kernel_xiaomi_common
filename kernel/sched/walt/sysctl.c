...
struct ctl_table walt_table[] = {
	...
	},
	{
		...
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
		.proc_handler	= dora_enable_handler,
		.extra1		= SYSCTL_ZERO,
		.extra2		= SYSCTL_ONE,
	},
	{
	...
	{
		.procname	= "sched_dora_stats",
		.data		= &sysctl_sched_dora_stats,
		.maxlen		= sizeof(unsigned long) * 4,
		.mode		= 0444,
		.proc_handler	= dora_stats_handler,
		.extra1		= SYSCTL_ZERO,
	},
	{
		.procname	= "sched_dora_reset_stats",
		.data		= &sysctl_sched_dora_reset_stats,
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
		.proc_handler	= dora_reset_stats_handler,
		.extra1		= SYSCTL_ZERO,
		.extra2		= SYSCTL_ONE,
	},
	{
